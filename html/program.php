...
<article class="container-fluid" style="margin-top:30px;width: 85%">
    <h2 class="display-4 text-center" style="display: block;margin-top: 60px">添加信息</h2>
    ...
    <form action="" method="post" class="container mx-auto" id="formtj">
        ...
        <div style="margin-top: 10px;height: 40px" class="card bg-light text-dark">
            <label for="sex" class="radio-inline card-body" style="height: 40px;padding:8px 0 8px 20px!important;">
                性 别 :
                <input type="radio" name="sex" id="sex" style="margin-left: 80px" value="男">男
                <input type="radio" name="sex" id="sex" style="margin-left: 50px" value="女">女
            </label>
        </div>
        ...
        <div class="input-group mb-3" style="margin-top: 20px">
            ...
            <input type="date" id="bri" name="bri" class="form-control">
        </div>
        ...
        <div style="margin-top: 10px;height: 40px" class="card bg-light text-dark">
            <label for="specialty" class="radio-inline card-body"
                ...
                爱 好 :
                <input type="checkbox" name="specialty[]" id="specialty" value="学习" style="margin-left: 20px">学习
                <input type="checkbox" name="specialty[]" id="specialty" value="唱">唱
                <input type="checkbox" name="specialty[]" id="specialty" value="跳">跳
                <input type="checkbox" name="specialty[]" id="specialty" value="打篮球">打篮球
            </label>
        </div>
        ...
        <div class="container mx-auto">
            <input type="submit" class="btn btn-primary" style="margin-left: 10%;width:30%" value="确认添加">
